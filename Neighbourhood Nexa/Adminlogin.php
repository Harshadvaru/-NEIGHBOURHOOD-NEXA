...
<div class="page">
       <div class="navbar">
           ...
           <h1>Neighbourhood <span style="font-family: 'Merienda', cursive;
            color:rgb(20, 76, 80);">Nexa</span></h1>
           <nav>
               <ul>
    ...
    <footer>
        <div class="main-content">
            <div class="left box">
                ...
                <div class="content">
                    <p>
                        Neighbourhood Nexa is webapp  where society members can get all the updates related to their society. The members also get notified with notices and events held in society and can see information about members in society. Members can also post complaints regarding any issue in society. 
                    </p>
                </div>
            </div>
            ...
            <div class="right box">
                ...
                <div class="content">
                    ...
                    <div class="phone">
                        ...
                        <span class="text">+91 9106978228</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">nhn@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
